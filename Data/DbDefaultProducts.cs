...
public static class DbDefaultProducts
{
    ...
    private static async Task SeedProductsAsync(AppDbContext context)
    {
        ...
        var products = new List<Product>
        {
            ...
            new Product {
                ...
                Description = "Consola portátil de nueva generación con pantalla LCD HDR de 7,9 pulgadas, 256 GB internos y conectividad moderna.",
                Price = 870m,
                Stock = 0,
                ReservedStock = 0,
                TotalSold = 11,
            ...
            new Product {
                ...
                Description = "Memoria RAM: 12 GB. Compatible con redes 5G. Pantalla Dynamic AMOLED 2X de 6.2. Cámara delantera de 10Mpx.",
                Price = 880m,
                Stock = 53,
                ReservedStock = 0,
                TotalSold = 999,
            ...
            new Product {
                ...
                Description = "Pantalla AMOLED de 6.67. Tiene 3 cámaras traseras de 108 MP + 2 MP + 2 MP. Procesador Mediatek Helio G99 Ultra.",
                Price = 240m,
                Stock = 5,
                ReservedStock = 0,
                TotalSold = 61,
            ...
            new Product {
                ...
                Description = "Memoria RAM: 12 GB. Compatible con redes 5G. Pantalla de 6.9. Memoria interna de 512GB.",
                Price = 1700m,
                Stock = 0,
                ReservedStock = 0,
                TotalSold = 42,
            ...
            new Product {
                ...
                Description = "Memoria RAM: 8 GB. Pantalla de 6.1. Memoria interna de 128GB. Con reconocimiento facial.",
                Price = 1024m,
                Stock = 4,
                ReservedStock = 0,
                TotalSold = 13,
            ...
            new Product {
                ...
                Description = "Compatible con redes 5G. Pantalla Super AMOLED de 6.7. Tiene 3 cámaras traseras.",
                Price = 510m,
                Stock = 18,
                ReservedStock = 0,
                TotalSold = 13,
            ...
            new Product {
                ...
                Description = "Pantalla Super Retina XDR de 6.1 pulgadas. Sistema avanzado de dos cámaras de 12 MP.",
                Price = 605m,
                Stock = 12,
                ReservedStock = 0,
                TotalSold = 5,
            ...
            new Product {
                ...
                Description = "Pantalla Super Retina XDR de 6.1 pulgadas. Sistema avanzado de cámaras.",
                Price = 750m,
                Stock = 5,
                ReservedStock = 0,
                TotalSold = 4,
            ...
            new Product {
                ...
                Description = "Tamaño de la memoria: 16 GB. Potencia gráfica total de 160 W para un rendimiento óptimo en juegos.",
                Price = 760m,
                Stock = 21,
                ReservedStock = 0,
                TotalSold = 82,
            ...
            new Product {
                ...
                Description = "Tamaño de la memoria: 12 GB. Interfaz PCI-Express 4.0. Memoria gráfica GDDR6.",
                Price = 470m,
                Stock = 5,
                ReservedStock = 0,
                TotalSold = 56,
            ...
            new Product {
                ...
                Description = "Tamaño de la memoria: 8 GB. Interfaz PCI-Express 5.0 para máxima compatibilidad y velocidad.",
                Price = 670m,
                Stock = 8,
                ReservedStock = 0,
                TotalSold = 44,
            ...
            new Product {
                ...
                Description = "Tamaño de la memoria: 12 GB. Interfaz PCI Express® Gen 5 para máxima velocidad.",
                Price = 1200m,
                Stock = 2,
                ReservedStock = 0,
                TotalSold = 15,
            ...
            new Product {
                ...
                Description = "Tamaño de la memoria: 8 GB. Interfaz PCI-E 5.0 para una conexión de alta velocidad y eficiencia.",
                Price = 660m,
                Stock = 7,
                ReservedStock = 0,
                TotalSold = 51,
    ...
    private static async Task SeedTestUsersAndOrdersAsync(AppDbContext context)
    {
        ...
        for (int i = 0; i < 24; i++)
        {
            ...
            {
                var maxQty = Math.Min(3, Math.Max(1, product.Stock));
            ...
            if (status == OrderStatuses.AwaitingPayment)
            {
                order.ReservationExpiresAt = DateTime.UtcNow.AddMinutes(rng.Next(5, 30));
            }
            else
            {
            ...
            if (status is OrderStatuses.Paid
                ...
                or OrderStatuses.Delivered)
            {
                order.MercadoPagoPaymentId = fakePaymentId++;
            }
